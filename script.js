...
window.dataPegawai = [];
const API_URL =
  "https://script.google.com/macros/s/AKfycbwF_layfoeJjtwWAV69Nlp8H_xV6ntFJZt59CYP3tLY1aVgo88Q_fwdqw7xZdT2j5jYJQ/exec";
...
async function submitAbsen() {
  ...
  // hanya jam 08:15 - 09:00
  if (
    hour < 8 ||
    hour >= 9 ||
    (hour === 8 && minute < 15)
  ) {
    alert("Absen hanya bisa pukul 08:15 - 09:00 WIB");
    return;
  }
